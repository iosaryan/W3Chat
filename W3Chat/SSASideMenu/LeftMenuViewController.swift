...
extension LeftMenuViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            ...
            sideMenuViewController?.contentViewController = UINavigationController(rootViewController: EditProfileVC())
            sideMenuViewController?.hideMenuViewController()
            break
        case 2:
            
            sideMenuViewController?.contentViewController = UINavigationController(rootViewController: SettingVC())
            sideMenuViewController?.hideMenuViewController()
            break
...
//            content.title = NSString.localizedUserNotificationString(forKey: "sunny said:", arguments: nil)
//            content.body = NSString.localizedUserNotificationString(forKey: "Hello Aryan！Get up", arguments: nil)
