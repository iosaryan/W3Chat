...
- (void)commonInit {
    ...
    _mode = MBProgressHUDModeIndeterminate; // Aryan************ change to solid state
    _margin = 5.0f; // Aryan************ size of hud
    _opacity = 0.5f; // Aryan************ darkness of hud
...
- (id)init {
    return [self initWithFrame:CGRectMake(.0f, .0f, 20.0f, 20.0f)];
}
...
- (void)setDimBackground:(BOOL)dimBackground {
    MBMainThreadAssert();
    self.backgroundView.style = MBProgressHUDModeCustomView;
